                ...
                <div className="mt-48">
                    <div className="w-4/5 mx-auto">
                        ...
                        <form onSubmit={onSubmit} noValidate>
                            ...
                            <button className="block w-full py-4 px-4 bg-primary text-white text-sm font-medium tracking-wide rounded-lg transition-all hover:bg-secondary">
                                Sign up — Free
                            </button>
                        </form>
                        <div className="text-xs text-center text-gray-500 mt-8">
                            ...
                            <Link
                                to="/signin"
                                className="text-primary font-medium hover:underline hover:text-black"
                            >
                                Sign in
                            </Link>
                        </div>
